        ...
        <nav className="flex flex-row gap-2 lg:flex-col">
          ...
          <Link href={'/admin/email-templates' as never}>
            <NavLinkContent
              ...
              isActive={pathname?.startsWith('/admin/email-templates') ?? false}
            />
          </Link>
          <Link href={'/admin/email-logs' as never}>
            <NavLinkContent
              icon={<EmailLogIcon />}
              label="E-Mail Logs"
              isActive={pathname?.startsWith('/admin/email-logs') ?? false}
            />
          </Link>
        </nav>
      </div>
