...
const schichtStatusConfig: Record<
  HelferschichtStatus,
  { label: string; className: string }
> = {
...
export function HelfereinsatzStatusBadge({
  status,
}: HelfereinsatzStatusBadgeProps) {
...
export function HelferschichtStatusBadge({
  status,
}: HelferschichtStatusBadgeProps) {
