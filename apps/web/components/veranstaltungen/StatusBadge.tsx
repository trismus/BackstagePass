import type { VeranstaltungStatus, VeranstaltungTyp, AnmeldungStatus } from '@/lib/supabase/types'

const statusConfig: Record<VeranstaltungStatus, { label: string; className: string }> = {
...
const typConfig: Record<VeranstaltungTyp, { label: string; className: string }> = {
  vereinsevent: { label: 'Vereinsevent', className: 'bg-blue-100 text-blue-800' },
...
const anmeldungStatusConfig: Record<AnmeldungStatus, { label: string; className: string }> = {
  angemeldet: { label: 'Angemeldet', className: 'bg-green-100 text-green-800' },
  warteliste: { label: 'Warteliste', className: 'bg-yellow-100 text-yellow-800' },
  abgemeldet: { label: 'Abgemeldet', className: 'bg-red-100 text-red-800' },
  teilgenommen: { label: 'Teilgenommen', className: 'bg-blue-100 text-blue-800' },
}
