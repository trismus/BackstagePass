-- =============================================================================
-- Migration: Include telefon in dashboard helper info
-- Created: 2026-03-11
-- Issue: #436
-- Description: Extend get_helfer_dashboard_data to return telefon field
--   so external helpers can see and edit their phone number in the dashboard.
-- =============================================================================
...
DECLARE
  ...
  v_zuweisungen JSONB;
BEGIN
  -- Validate token and get helper info (now including telefon)
