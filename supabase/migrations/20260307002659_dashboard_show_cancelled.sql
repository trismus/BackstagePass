-- =============================================================================
-- Migration: Show cancelled registrations in helfer dashboard
-- Created: 2026-03-07
-- Issue: #419
-- Description: Remove the status != 'abgelehnt' filter from
--   get_helfer_dashboard_data so cancelled registrations appear in the
--   personal dashboard with status 'Abgemeldet'.
-- =============================================================================
...
BEGIN
  ...
  -- Get all registrations (including cancelled) with event and role details
